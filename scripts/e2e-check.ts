/**
 * End-to-end smoke check for the WanningGate counter contract.
 *
...
import { createCounterPrivateState } from '../src/witnesses';
import { getOrCreateClaimSecret } from '../src/claim-secret';
import { PRIVATE_STATE_ID, loadCompiledContract, zkConfigPath } from '../src/contract';
...
// Same private state the deploy script used. Read-only here, but the contract
// must be able to construct it to reconnect.
